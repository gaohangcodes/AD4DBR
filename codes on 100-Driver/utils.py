...
from models.mymodels import MSFIN_student11_without_ca,MSFIN_student14_without_ca,MSFIN_student14,MSFIN_student11,MSFIN_teacher
import timm
import torch.nn as nn
from models.can import MobilenetCA
from models.fd import learningDIF
def get_torch_network(args):
    ...
    #inceptionv3
    ...
    elif args.net == 'my_ca_14':
        net = model.mobilenet_v2(pretrained=True)
        net = modify_output(args, net)
    
        net = net.cuda()
        checkpoint = torch.load(args.teacher_root)
        net.load_state_dict(checkpoint)
        teacher = MSFIN_teacher(net)
        net = MSFIN_student14(teacher)
    elif args.net == 'my_ca_11':
        net = model.mobilenet_v2(pretrained=True)
        net = modify_output(args, net)
        ...
        net.load_state_dict(checkpoint)
        teacher = MSFIN_teacher(net)
        net = MSFIN_student11(teacher)
    elif args.net == 'my_ca_14_distilledfromCA':
        net = MobilenetCA()
        #net = modify_output(args, net)
        ...
        teacher = MSFIN_teacher(net)
        net = MSFIN_student14(teacher)
    elif args.net == 'my_ca_11_distilledfromCA':
        net = MobilenetCA()
        #net = modify_output(args, net)
        ...
        teacher = MSFIN_teacher(net)
        net = MSFIN_student11(teacher)
    elif args.net == 'my_14_withoutca':
        
        net = MSFIN_student14_without_ca()
    elif args.net == 'my_11_withoutca':
        
        net = MSFIN_student11_without_ca()
    
    
    elif args.net == 'can':
        net = MobilenetCA()
    elif args.net == 'fd':
        net = learningDIF(driver_num=args.driver_num)
    else:
...
#Traditional setting for Cam1,2,3,4; if other settings are required, just add it in another elif         
    if dataset == 'pic-day-cam1':
        trainloader = 'data/100-driver/Day/Cam1'
        trainloadertxt = 'data-splits/Traditional-setting/Day/Cam1/D1_train.txt'
        valloader = 'data/100-driver/Day/Cam1'
        valloadertxt = 'data-splits/Traditional-setting/Day/Cam1/D1_val.txt'
    elif dataset == 'pic-day-cam2':
        trainloader = 'data/100-driver/Day/Cam2'
        trainloadertxt = 'data-splits/Traditional-setting/Day/Cam2/D2_train.txt'
        valloader = 'data/100-driver/Day/Cam2'
        valloadertxt = 'data-splits/Traditional-setting/Day/Cam2/D2_val.txt'
    elif dataset == 'pic-day-cam3':
        trainloader = 'data/100-driver/Day/Cam3'
        trainloadertxt = 'data-splits/Traditional-setting/Day/Cam3/D3_train.txt'
        valloader = 'data/100-driver/Day/Cam3'
        valloadertxt = 'data-splits/Traditional-setting/Day/Cam3/D3_val.txt'
    elif dataset == 'pic-day-cam4':
        trainloader = 'data/100-driver/Day/Cam4'
        trainloadertxt = 'data-splits/Traditional-setting/Day/Cam4/D4_train.txt'
        valloader = 'data/100-driver/Day/Cam4'
        valloadertxt = 'data-splits/Traditional-setting/Day/Cam4/D4_val.txt'
    elif dataset == 'pic-night-cam1':
        trainloader = 'data/100-driver/Night/Cam1'
        trainloadertxt = 'data-splits/Traditional-setting/Night/Cam1/N1_train.txt'
        valloader = 'data/100-driver/Night/Cam1'
        valloadertxt = 'data-splits/Traditional-setting/Night/Cam1/N1_val.txt'
    elif dataset == 'pic-night-cam2':
        trainloader = 'data/100-driver/Night/Cam2'
        trainloadertxt = 'data-splits/Traditional-setting/Night/Cam2/N2_train.txt'
        valloader = 'data/100-driver/Night/Cam2'
        valloadertxt = 'data-splits/Traditional-setting/Night/Cam2/N2_val.txt'
    elif dataset == 'pic-night-cam3':
        trainloader = 'data/100-driver/Night/Cam3'
        trainloadertxt = 'data-splits/Traditional-setting/Night/Cam3/N3_train.txt'
        valloader = 'data/100-driver/Night/Cam3'
        valloadertxt = 'data-splits/Traditional-setting/Night/Cam3/N3_val.txt'
    elif dataset == 'pic-night-cam4':
        trainloader = 'data/100-driver/Night/Cam4'
        trainloadertxt = 'data-splits/Traditional-setting/Night/Cam4/N4_train.txt'
        valloader = 'data/100-driver/Night/Cam4'
        valloadertxt = 'data-splits/Traditional-setting/Night/Cam4/N4_val.txt'
...
#Traditional setting for Cam1,2,3,4; if other settings are required, just add it in another elif         
    if dataset == 'pic-day-cam1':
        testloader = 'data/100-driver/Day/Cam1'
        testloadertxt = 'data-splits/Traditional-setting/Day/Cam1/D1_test.txt'
    elif dataset == 'pic-day-cam2':
        testloader = 'data/100-driver/Day/Cam2'
        testloadertxt = 'data-splits/Traditional-setting/Day/Cam2/D2_test.txt'
    elif dataset == 'pic-day-cam3':
        testloader = 'data/100-driver/Day/Cam3'
        testloadertxt = 'data-splits/Traditional-setting/Day/Cam3/D3_test.txt'
    elif dataset == 'pic-day-cam4':
        testloader = 'data/100-driver/Day/Cam4'
        testloadertxt = 'data-splits/Traditional-setting/Day/Cam4/D4_test.txt'
    elif dataset == 'pic-night-cam1':
        testloader = 'data/100-driver/Night/Cam1'
        testloadertxt = 'data-splits/Traditional-setting/Night/Cam1/N1_test.txt'
    elif dataset == 'pic-night-cam2':
        testloader = 'data/100-driver/Night/Cam2'
        testloadertxt = 'data-splits/Traditional-setting/Night/Cam2/N2_test.txt'
    elif dataset == 'pic-night-cam3':
        testloader = 'data/100-driver/Night/Cam3'
        testloadertxt = 'data-splits/Traditional-setting/Night/Cam3/N3_test.txt'
    elif dataset == 'pic-night-cam4':
        testloader = 'data/100-driver/Night/Cam4'
        testloadertxt = 'data-splits/Traditional-setting/Night/Cam4/N4_test.txt'
    else:
        print('the dataset is not available ')
